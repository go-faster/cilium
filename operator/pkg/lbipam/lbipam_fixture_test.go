...
import (
	...
	"github.com/go-faster/cilium/pkg/k8s/client/clientset/versioned/typed/cilium.io/v2alpha1"
	...
	client_core_v1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1"
