...
import (
	...
	cilium_clientset "github.com/go-faster/cilium/pkg/k8s/client/clientset/versioned"
	...
	slim_apiextclientsetscheme "github.com/go-faster/cilium/pkg/k8s/slim/k8s/apiextensions-client/clientset/versioned/scheme"
	slim_apiext_clientset "github.com/go-faster/cilium/pkg/k8s/slim/k8s/apiextensions-clientset"
	slim_metav1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/apis/meta/v1"
	slim_metav1beta1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/apis/meta/v1beta1"
	slim_clientset "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned"
