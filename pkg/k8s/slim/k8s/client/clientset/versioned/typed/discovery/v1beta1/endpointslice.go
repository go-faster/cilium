...
import (
	...
	v1beta1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/api/discovery/v1beta1"
	scheme "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/scheme"
