...
import (
	clientset "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned"
	corev1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1"
	fakecorev1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/core/v1/fake"
	discoveryv1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1"
	fakediscoveryv1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1/fake"
	discoveryv1beta1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1beta1"
	fakediscoveryv1beta1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/discovery/v1beta1/fake"
	networkingv1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/networking/v1"
	fakenetworkingv1 "github.com/go-faster/cilium/pkg/k8s/slim/k8s/client/clientset/versioned/typed/networking/v1/fake"
