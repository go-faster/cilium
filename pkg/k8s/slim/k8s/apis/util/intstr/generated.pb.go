...
// source: github.com/go-faster/cilium/pkg/k8s/slim/k8s/apis/util/intstr/generated.proto
...
func init() {
	proto.RegisterFile("github.com/go-faster/cilium/pkg/k8s/slim/k8s/apis/util/intstr/generated.proto", fileDescriptor_8984be45904ea297)
}
