...
Next, obtain Cilium manifest from ``go-faster/cilium-olm`` repository and copy to ``${CLUSTER_NAME}/manifests``:
...
.. parsed-literal::
   ...
   git clone https://github.com/go-faster/cilium-olm.git ${git_dir}
