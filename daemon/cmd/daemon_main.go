...
import (
	...
	"github.com/go-faster/cilium/pkg/datapath/iptables"
	...
	"github.com/go-faster/cilium/pkg/datapath/maps"
	...
	"github.com/go-faster/cilium/pkg/ipmasq"
	...
	"github.com/go-faster/cilium/pkg/maglev"
	"github.com/go-faster/cilium/pkg/maps/ctmap"
	"github.com/go-faster/cilium/pkg/maps/ctmap/gc"
	...
	"github.com/go-faster/cilium/pkg/maps/neighborsmap"
	...
	wireguard "github.com/go-faster/cilium/pkg/wireguard/agent"
	wireguardTypes "github.com/go-faster/cilium/pkg/wireguard/types"
)
...
func initializeFlags() {
	...
	// See https://github.com/go-faster/cilium/pull/20282 for more information.
...
func initEnv() {
	...
	if option.Config.IPAM == ipamOption.IPAMAzure {
		...
		log.WithFields(logrus.Fields{
			"URL": "https://github.com/go-faster/cilium/issues/14705",
		}).Infof(
