...
import (
	...
	bgpv1 "github.com/go-faster/cilium/pkg/bgpv1/agent"
	"github.com/go-faster/cilium/pkg/bpf"
	"github.com/go-faster/cilium/pkg/cgroups/manager"
	...
	"github.com/go-faster/cilium/pkg/datapath/linux/bigtcp"
	"github.com/go-faster/cilium/pkg/datapath/linux/ipsec"
	...
	"github.com/go-faster/cilium/pkg/egressgateway"
	...
	"github.com/go-faster/cilium/pkg/hubble/observer"
	...
	ipcachemap "github.com/go-faster/cilium/pkg/maps/ipcache"
	...
	monitoragent "github.com/go-faster/cilium/pkg/monitor/agent"
	...
	"github.com/go-faster/cilium/pkg/probe"
	"github.com/go-faster/cilium/pkg/proxy"
	...
	"github.com/go-faster/cilium/pkg/sockops"
	"github.com/go-faster/cilium/pkg/source"
	"github.com/go-faster/cilium/pkg/status"
	"github.com/go-faster/cilium/pkg/trigger"
	wg "github.com/go-faster/cilium/pkg/wireguard/agent"
...
func newDaemon(ctx context.Context, cleaner *daemonCleanup,
	...
	if option.Config.BGPAnnounceLBIP || option.Config.BGPAnnouncePodCIDR {
		log.WithField("url", "https://github.com/go-faster/cilium/issues/22246").
	...
	if option.Config.EnableIPv4EgressGateway {
		...
		if option.Config.EnableL7Proxy {
			log.WithField(logfields.URL, "https://github.com/go-faster/cilium/issues/19642").
